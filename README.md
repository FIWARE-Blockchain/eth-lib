...
[![Build Status](https://travis-ci.org/FIWARE-Blockchain/eth-lib.svg?branch=master)](https://travis-ci.org/FIWARE-Blockchain/eth-lib)
[![dependencies Status](https://img.shields.io/david/FIWARE-Blockchain/eth-lib)](https://img.shields.io/david/FIWARE-Blockchain/eth-lib)
[![devDependencies Status](https://img.shields.io/david/dev/FIWARE-Blockchain/eth-lib)](https://img.shields.io/david/dev/FIWARE-Blockchain/eth-lib)
[![Support badge](https://nexus.lab.fiware.org/repository/raw/public/badges/stackoverflow/fiware.svg)](https://stackoverflow.com/questions/tagged/fiware)
[![Github issues](https://img.shields.io/github/issues/FIWARE-Blockchain/eth-lib)](https://github.com/FIWARE-Blockchain/eth-lib/issues)
[![Coverage Status](https://coveralls.io/repos/github/FIWARE-Blockchain/eth-lib/badge.svg?branch=master)](https://coveralls.io/github/FIWARE-Blockchain/eth-lib?branch=master)
[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](https://opensource.org/licenses/MIT)

This project is a library (wrapper around eth) ot integrate with FIWARE.
...
Energy. eth is an open-source distributed ledger that is being built to power the future of the Internet of Things with
feeless microtransactions and data integrity for machines. This library is an intial library(wrapper around eth libs)
to support FIWARE Ecosystem.

# Installation

```sh
npm install --save eth-lib
```
...
| --------- | ------ | ----------------- | --------------------------------------------------------------------- |
| data      | string |                   | data to be submitted in eth                                          |
...
```js
import { getNodeInfo } from "eth-lib";
...
```js
import { generateSeed, createNewAddress } from "eth-lib";
//generate a new seed
...
```js
import { fetchTransaction } from "eth-lib";
...
```js
import { statusTransaction } from "eth-lib";
...
```js
import { createMamTransaction } from "eth-lib";
...
```js
import { fetchMamTransaction, decodeMessage } from "eth-lib";
...
[MIT](https://github.com/FIWARE-Blockchain/eth-lib/blob/master/LICENSE) © 2020 FIWARE Foundation e.V.
